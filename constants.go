...
const (
	VIR_MIGRATE_LIVE              = C.VIR_MIGRATE_LIVE
	VIR_MIGRATE_PEER2PEER         = C.VIR_MIGRATE_PEER2PEER
	VIR_MIGRATE_TUNNELLED         = C.VIR_MIGRATE_TUNNELLED
	VIR_MIGRATE_PERSIST_DEST      = C.VIR_MIGRATE_PERSIST_DEST
	VIR_MIGRATE_UNDEFINE_SOURCE   = C.VIR_MIGRATE_UNDEFINE_SOURCE
	VIR_MIGRATE_PAUSED            = C.VIR_MIGRATE_PAUSED
	VIR_MIGRATE_NON_SHARED_DISK   = C.VIR_MIGRATE_NON_SHARED_DISK
	VIR_MIGRATE_NON_SHARED_INC    = C.VIR_MIGRATE_NON_SHARED_INC
	VIR_MIGRATE_CHANGE_PROTECTION = C.VIR_MIGRATE_CHANGE_PROTECTION
	VIR_MIGRATE_UNSAFE            = C.VIR_MIGRATE_UNSAFE
	VIR_MIGRATE_OFFLINE           = C.VIR_MIGRATE_OFFLINE
	VIR_MIGRATE_COMPRESSED        = C.VIR_MIGRATE_COMPRESSED
	VIR_MIGRATE_ABORT_ON_ERROR    = C.VIR_MIGRATE_ABORT_ON_ERROR
	VIR_MIGRATE_AUTO_CONVERGE     = C.VIR_MIGRATE_AUTO_CONVERGE
	VIR_MIGRATE_RDMA_PIN_ALL      = C.VIR_MIGRATE_RDMA_PIN_ALL
)
